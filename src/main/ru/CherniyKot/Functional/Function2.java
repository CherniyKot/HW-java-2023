...
public interface Function2<RetType, ArgType1, ArgType2> extends Function1<RetType, Map.Entry<ArgType1, ArgType2>> {
    ...
    @Override
    default RetType apply(@NotNull Map.Entry<ArgType1, ArgType2> arg) {
        return apply(arg.getKey(), arg.getValue());
    }

    @NotNull
    default <RetT> Function2<RetT, ArgType1, ArgType2> compose(@NotNull Function1<RetT, ? super RetType> func) {
